...
<head>
    ...
    <!-- Gritter -->
    <link href="<%=request.getServletContext().getContextPath() %>/static/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
