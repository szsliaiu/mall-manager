            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>商品缩略图上传  &nbsp; &nbsp;<span style="color: red;">${message}</span></h5>
                    ...
                    <div class="ibox-content">
                        <form action="<%=request.getServletContext().getContextPath() %>/admin/goods/toGoodPicEdit" 
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">缩略图选择</label>
                                <div class="col-sm-10">
                                    <input type="file" name="picture" class="form-control"> <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>                           
                            <div class="form-group">
