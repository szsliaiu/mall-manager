                    ...
                    <div class="ibox-content">
                        <form action="<%=request.getServletContext().getContextPath() %>/admin/adminAddSave" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="fakename" class="form-control"> <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="username" class="form-control"> <span class="help-block m-b-none"></span>
                                </div>
                            </div>
