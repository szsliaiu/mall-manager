...
<body>
 <div class="mianCont">
  <div class="top">
   ...
   <span class="topRight">
   <a href="<%=request.getServletContext().getContextPath()%>/admin/toLogin">登录</a>
  ...
  <div class="pnt">
   ...
   <div class="pntRight">
    <ul class="nav">
     ...
     <li><a href="<%=request.getServletContext().getContextPath()%>/mall/toProduct">促销中心</a></li>
    ...
    <div class="banner">
     <div id="kinMaxShow">
      <div>
       <a href="#"><img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/ban1.jpg" height="360"  /></a>
      </div> 		
      <div>
       <a href="#"><img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/ban2.jpg" height="360"  /></a>
      </div>
      <div>
       <a href="#"><img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/ban3.jpg" height="360"  /></a>
      </div>
      <div>
       <a href="#"><img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/ban4.jpg" height="360"  /></a>
      </div>
      <div>
       <a href="#"><img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/ban5.jpg" height="360"  /></a>
      </div>      
     </div><!--kinMaxShow/-->
    </div><!--banner/-->
   </div><!--pntRight/-->
  ...
  <div class="rdPro">
   <div class="rdLeft">
    ...
    <div class="rdProBox">
     <dl>
      <dt><a href="proinfo.html"><img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/rdPro1.jpg" width="132" height="129" /></a></dt>
      <dd>妙洁 一次性纸杯 8盎司228ml 100只/袋 20袋/箱</dd>
      <dd class="cheng">￥19.80/袋</dd>
     </dl>
     <dl>
      <dt><a href="proinfo.html"><img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/rdPro2.jpg" width="132" height="129" /></a></dt>
      <dd>妙洁 一次性纸杯 8盎司228ml 100只/袋 20袋/箱</dd>
      <dd class="cheng">￥19.80/袋</dd>
     </dl>
     <dl>
      <dt><a href="proinfo.html"><img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/rdPro3.jpg" width="132" height="129" /></a></dt>
      <dd>妙洁 一次性纸杯 8盎司228ml 100只/袋 20袋/箱</dd>
      <dd class="cheng">￥19.80/袋</dd>
     </dl>
     <dl>
      <dt><a href="proinfo.html"><img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/rdPro4.jpg" width="132" height="129" /></a></dt>
      <dd>妙洁 一次性纸杯 8盎司228ml 100只/袋 20袋/箱</dd>
      <dd class="cheng">￥19.80/袋</dd>
     </dl>
     <dl>
      <dt><a href="proinfo.html"><img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/rdPro5.jpg" width="132" height="129" /></a></dt>
      <dd>妙洁 一次性纸杯 8盎司228ml 100只/袋 20袋/箱</dd>
      <dd class="cheng">￥19.80/袋</dd>
     </dl>
     <div class="clears"></div>
   ...
   <div class="rdRight">
    <img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/rdRight.jpg" width="221" height="254" />
   </div><!--rdRight/-->
   <div class="clears"></div>
  </div><!--rdPro/-->
  <div class="hengfu">
   <img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/hengfu1.jpg" width="979" height="97" />
  </div><!--hengfu/-->
  <div class="floor" id="floor1">
   ...
   <div class="floorBox">
    <div class="floorLeft">
     ...
     <div class="flImg"><img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/flListimg.jpg" width="198" height="290" /></div>
    </div><!--floorLeft/-->
  ...
  <div class="hengfu">
   <img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/hengfu2.jpg" width="978" height="97" />
  </div><!--hengfu/-->
  ...
  <div class="hengfu">
   <img src="<%=request.getServletContext().getContextPath() %>/static/mall/images/hengfu1.jpg" width="978" height="97" />
  </div><!--hengfu/-->
  ...
  <div class="footer">
   ...
   <a href="login.html">会员中心</a>&nbsp;|&nbsp;
   <a href="https://www.baidu.com">帮助中心</a>&nbsp;|&nbsp;
   <a href="<%=request.getServletContext().getContextPath()%>/admin/toLogin">管理系统</a>
   </p>
   <p>
    版权所有：66公司 版权所有  Copyright 2010-2020   XXX
   </p>
  </div><!--footer/-->
 </div><!--mianCont/-->
